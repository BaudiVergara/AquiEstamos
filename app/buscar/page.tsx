  ...
  return (
    <main className="min-h-screen bg-slate-100 p-6">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <p className="mt-2 text-gray-600">Busca una persona por nombre.</p>
        ...
        <div className="mt-8 space-y-4">
          {results.map((person) => (
            ...
            >
              ...
              <p className="mt-2">📍 {person.incidents.address}</p>

              <p>👥 Personas estimadas: {person.incidents.people_estimated}</p>

              <p>📝 {person.incidents.notes}</p>
